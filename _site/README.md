...
I have created a multi-language 'al-folio-for-Chinese' based on [George](https://github.com/george-gca/multi-language-al-folio)'s excellent work. This version supports Chinese characters such as '中文' and '繁'. Additionally, I have fixed the bug where HTML could not use the `[]` operator to index Chinese characters.
